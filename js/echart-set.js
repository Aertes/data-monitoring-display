var MyChartMap = echarts.init(document.getElementById("MyChartMap"));
...
MyChartMapOption = {
    ...
    geo: {
        ...
        itemStyle: {
            normal: {
                areaColor: 'rgba(32,132,169,.5)',/*#323c48*/
                borderColor: '#fff'/*#111*/
            },
            emphasis: {
                areaColor: 'rgba(49,67,103,.5)'/*#2a333d*/
            }
        },
        left: '100px',
        top:'50px'
...
MyChartMap.setOption(MyChartMapOption)